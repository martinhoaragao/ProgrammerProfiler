    ...
    p =q.nextLong();
    BigInteger ini = new BigInteger("1000000000000000001");
    ...
    i= new BigInteger("1000000000000000400");
    while(ini.compareTo(i)==-1){
    if(ini.isProbablePrime(2)){
    a[k++]=ini;
    }
    ini=ini.add(BigInteger.valueOf(2));
    }
    x=k;
    while(p-- !=0){
    flag=false;
