...
public class Main {
	public static void main(String[] args) throws IOException {
		...
		final BufferedOutputStream bos = new BufferedOutputStream(fdout,
				200000 * 32);
		...
		final BufferedReader br = new BufferedReader(new InputStreamReader(
				System.in));
		final int noOfCases = Integer.parseInt(br.readLine());
		for (int i = 0; i < noOfCases; i++) {
			final int size = Integer.parseInt(br.readLine());
			final String movementStr = br.readLine();
			final StringTokenizer tokenizer = new StringTokenizer(movementStr,
					" ");
			int k = 0;
	...
	public static void reorder(final int[][] moves, final int startIndex,
			final int endIndex, final int[][] tmpArr) {
	...
	public static void merge(final int[][] moves, final int startIndex,
			final int middleIndex, final int endIndex, final int[][] arr1) {
